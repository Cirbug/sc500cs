...
begin
    case(REG_INDEX)
		...
		22:	REG_DATA = {16'h3200, 8'h01}; //22:	REG_DATA = {16'h3200, 8'h01}; 
		23:	REG_DATA = {16'h3201, 8'h54}; //23:	REG_DATA = {16'h3201, 8'h54}; 
		24:	REG_DATA = {16'h3202, 8'h01}; //24:	REG_DATA = {16'h3202, 8'h01}; 
		25:	REG_DATA = {16'h3203, 8'hb4}; //25:	REG_DATA = {16'h3203, 8'hb4}; 
		26:	REG_DATA = {16'h3204, 8'h08}; //26:	REG_DATA = {16'h3204, 8'h08}; 
		27:	REG_DATA = {16'h3205, 8'hdb}; //27:	REG_DATA = {16'h3205, 8'hdb}; 
		28:	REG_DATA = {16'h3206, 8'h05}; //28:	REG_DATA = {16'h3206, 8'h05}; 
		29:	REG_DATA = {16'h3207, 8'hf3}; //29:	REG_DATA = {16'h3207, 8'hf3}; 
		30:	REG_DATA = {16'h3208, 8'h0a}; //窗口宽度//30:	REG_DATA = {16'h3208, 8'h04}; 
		31:	REG_DATA = {16'h3209, 8'h20}; ///////////31:	REG_DATA = {16'h3209, 8'h00}; 
		32:	REG_DATA = {16'h320a, 8'h07}; //窗口高度//32:	REG_DATA = {16'h320a, 8'h02}; 
		33:	REG_DATA = {16'h320b, 8'h98}; ////////////33:	REG_DATA = {16'h320b, 8'h58}; 
		34:	REG_DATA = {16'h320c, 8'h0b}; 
		35:	REG_DATA = {16'h320d, 8'h24}; 
		36:	REG_DATA = {16'h320e, 8'h04}; 
		37:	REG_DATA = {16'h320f, 8'h67}; 
		38:	REG_DATA = {16'h3210, 8'h00}; //列起始
		39:	REG_DATA = {16'h3211, 8'h04}; 
		40:	REG_DATA = {16'h3212, 8'h00}; //宽起始
