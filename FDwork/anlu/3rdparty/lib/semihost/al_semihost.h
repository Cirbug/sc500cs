...
#ifndef AL_SEMIHOST_TYPES_H_
#define AL_SEMIHOST_TYPES_H_
...
static inline AL_S32 AlLog_SemihostWrite(AL_VOID* Device, AL_U8* Data, AL_U32 Len)
{
    (AL_VOID)Device;
    (AL_VOID)semihost_write(SEMIHOST_STDOUT, Data, Len);
